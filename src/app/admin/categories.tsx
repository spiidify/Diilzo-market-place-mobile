...
export default function AdminCategoriesScreen() {
  ...
  return (
    <View style={styles.screen}>
      <ModernHeader title="Categories" rightIcon="plus" onRightPress={openCreate} />
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <View style={styles.emptyState}>
                <MaterialCommunityIcons name="folder-open-outline" size={48} color={colors.textTertiary} />
...
const createStyles = (c: ThemeColors) => StyleSheet.create({
  ...
  catName: { fontSize: 15, fontWeight: '800', color: c.text, flex: 1, marginRight: 8 },
  badge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  badgeText: { fontSize: 11, fontWeight: '700' },
  slug: { fontSize: 13, color: c.textSecondary, marginBottom: 8 },
