...
const MENU_SECTIONS: { title: string; items: MenuItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: 'badge-account', label: 'Platform Staff', route: '/admin/staff', color: '#8B5CF6' },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: 'percent-circle', label: 'Commission Config', route: '/admin/commission-config', color: '#8B5CF6' },
    ],
  },
  {
    title: 'Platform',
