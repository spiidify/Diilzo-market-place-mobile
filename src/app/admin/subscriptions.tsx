...
export default function AdminSubscriptionsScreen() {
  ...
  return (
    <View style={styles.screen}>
      <ModernHeader title="Subscriptions" />
      <View style={styles.body}>
        <View style={styles.summaryContainer}>
          ...
          <View style={styles.summaryCard}>
            ...
            <Text style={[styles.summaryValue, { color: colors.text }]} numberOfLines={1}>UGX {Number(summary.revenue).toLocaleString()}</Text>
          </View>
        </View>
...
const createStyles = (c: ThemeColors) => StyleSheet.create({
  ...
  planText: { fontSize: 14, fontWeight: '600', color: c.text, marginBottom: 8 },
