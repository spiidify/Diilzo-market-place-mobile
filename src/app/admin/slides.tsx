          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <ScrollView style={{ maxHeight: '75%' }} showsVerticalScrollIndicator={false}>
                ...
                <TextInput style={styles.input} value={form.title} onChangeText={(v) => setForm({ ...form, title: v })} placeholder="Slide title" placeholderTextColor={colors.textTertiary} />
                <Text style={styles.fieldLabel}>Headline</Text>
                <TextInput style={styles.input} value={form.headline} onChangeText={(v) => setForm({ ...form, headline: v })} placeholder="Headline" placeholderTextColor={colors.textTertiary} />
                ...
                <TextInput style={styles.input} value={form.cta_link} onChangeText={(v) => setForm({ ...form, cta_link: v })} placeholder="/shop" placeholderTextColor={colors.textTertiary} />
                <Text style={styles.fieldLabel}>Sort Order</Text>
                <TextInput style={styles.input} value={String(form.sort_order)} onChangeText={(v) => setForm({ ...form, sort_order: Number(v) || 0 })} placeholder="0" placeholderTextColor={colors.textTertiary} keyboardType="numeric" />
...
const createStyles = (c: ThemeColors) => StyleSheet.create({
  ...
  slideTitle: { fontSize: 15, fontWeight: '800', color: c.text, flex: 1, marginRight: 8 },
  badge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  badgeText: { fontSize: 11, fontWeight: '700' },
  headline: { fontSize: 14, fontWeight: '600', color: c.text, marginBottom: 2 },
  subheadline: { fontSize: 13, color: c.textSecondary, marginBottom: 8 },
  ...
  posTab: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, backgroundColor: c.surfaceAlt, borderWidth: 1, borderColor: c.border, marginRight: 8 },
  posTabActive: { backgroundColor: Brand.primary, borderColor: Brand.primary },
  posTabText: { fontSize: 13, fontWeight: '600', color: c.textSecondary },
