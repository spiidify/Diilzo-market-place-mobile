...
export default function SellerDashboardScreen() {
  ...
  const menuItems = [
    ...
    { icon: 'cash', label: 'Payouts', color: '#16A34A', route: '/seller/payouts' as any },
    { icon: 'chart-pie', label: 'Finance', color: '#16A34A', route: '/seller/finance' as any },
    ...
    { icon: 'account-group', label: 'Staff', color: '#3B82F6', route: '/seller/staff' as any },
